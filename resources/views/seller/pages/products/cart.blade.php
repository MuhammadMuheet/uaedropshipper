                        ...
                        <div class="row layout-spacing">
                            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                                <div class="widget-content widget-content-area card">
                                 ...
                                 $cartItems = \App\Models\Cart::where('seller_id', auth()->id())->count();
                                 }else{
                    ...
                    <div id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                        ...
                        <form  method="post" id="updateCartForm" enctype="multipart/form-data">
                            ...
                            <div class="text-center">
                                ...
                                <button type="button" onclick="update_cart()" id="edit_kt_modal_new_target_submit" class="btn btn-primary">
