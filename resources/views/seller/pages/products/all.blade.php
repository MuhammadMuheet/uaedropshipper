                ...
                <span class="svg-icon svg-icon-1 position-absolute ms-6">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <path d="M11 19C6.55556 19 3 15.4444 3 11C3 6.55556 6.55556 3 11 3C15.4444 3 19 6.55556 19 11C19 15.4444 15.4444 19 11 19ZM11 5C7.53333 5 5 7.53333 5 11C5 14.4667 7.53333 17 11 17C14.4667 17 17 14.4667 17 11C17 7.53333 14.4667 5 11 5Z" fill="currentColor" />
                                ...
                                <input type="text" id="search" class="form-control form-control-solid w-100 ps-15" placeholder="Search" oninput="fetchProducts()" />
                            </div>
                        </div>
                    </div>
                        <div id="product-list">
                        ...
                        <form  method="post" id="addToCartForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-8">
                                    ...
                                    <input type="number" class="form-control form-control-solid" name="quantity" id="quantity" min="1" value="1">
                                </div>
                            </div>
                            <div class="text-center">
                                <button type="button" class="btn btn-light me-3" data-bs-dismiss="modal">Cancel</button>
                                <button type="button" onclick="add_to_cart()" id="edit_kt_modal_new_target_submit" class="btn btn-primary">
