                        ...
                        <form  method="post" id="InsertForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class=" col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control form-control-solid" placeholder="Enter Role" name="name">
                                </div>
                            </div>
                        ...
                        <form  method="post" id="editForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control form-control-solid" placeholder="Enter Role" name="edit_name" id="edit_name">
                                </div>
                            </div>
                            <div class="text-center">
                                <button type="button" class="btn btn-light me-3" data-bs-dismiss="modal">Cancel</button>
            ...
            $.ajax({
                ...
                type: 'GET', data: {
                    ...
                    if (data == 1) {
                        ...
                        toastr.error('This Role is Assigned to users Please Unassigned This role First');
                    } else if (data == 0) {
                        toastr.error('This Role Not Found');
                    } else {
                        toastr.error('Something went wrong.');
