                ...
                <div class="card mb-5 mb-xl-10">
                    <div class="card-body pt-9 pb-0">
                        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                            <div class="me-7 mb-4">
                                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative bg-light-danger"
                                    id="view_doc">
                                    ...
                                    @else
                                        <img src="https://avatar.iran.liara.run/username?username={{ Auth::user()->name }}"
                                            alt="avatar">
                                    @endif
                                </div>
                            </div>
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="d-flex align-items-center mb-2">
                                            <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1"
                                                id="fullNameFirst">{{ Auth::user()->name }}</a>
                                            <a href="#">
                                            ...
                                            <div
                                                ...
                                                <a href="">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="fs-2 fw-bolder text-dark" data-kt-countup="true"
                                                            data-kt-countup-prefix="" id="appointmentCount">
                                                            0
                                                        </div>
                                                    </div>
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 @if (Request::url() == route('seller_profile')) active @endif"
                                    href="{{ route('seller_profile') }}">Basic
                                    Info</a>
                            </li>

                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 @if (Request::url() == route('seller_security')) active @endif"
                                    href="{{ route('seller_security') }}">Security</a>
                            </li>

                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 @if (Request::url() == route('seller_security')) active @endif"
                                    href="{{ route('connect_shopify') }}">Connect Shopify</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        ...
                        <form id="kt_account_profile_details_form" method="post" enctype="multipart/form-data"
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true"
                                            style="background-image: url({{ asset('assets/media/svg/avatars/blank.svg') }});background-position: center; background-size: contain;">
                                            <!--begin::Preview existing avatar-->
                                            <div class="image-input-wrapper w-125px h-125px"
                                                style="background-image: url('{{ asset('storage/users/' . Auth::user()->image) }}');background-position: center; background-size: contain;">
                                            </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="email" name="email"
                                            ...
                                            placeholder="exmaple@gmail.com" readonly>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                </div>
                                <div class="row mb-6">
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <button type="button" onclick="update_tool()" class="btn btn-primary"
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                ...
                                <div class="form-text">Enter your Shopify store URL (e.g., yourstore.myshopify.com)</div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <a href="javascript:void(0);" class="btn btn-light-primary">Connect with Shopify</a>
                                <div class="form-text text-muted">After entering your store URL, click to initiate
                                    connection</div>
                            </div>
                        </div>
...
@push('js')
    <script>
        ...
        function get_profile() {
            ...
            $.ajax({
                ...
                success: function(dataResult) {
                    ...
                    $('input[name=email]').val(dataResult.email);
                    $('input[name=mobile]').val(dataResult.mobile);
                }
            });
        }
        ...
        function update_tool() {
            ...
            $.ajax({
                url: "{{ route('seller_profile_update') }}",
                type: "POST",
                data: form_Data,
                contentType: false,
                cache: false,
