                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 @if(Request::url() == route('seller_profile')) active @endif" href="{{route('seller_profile')}}">Basic
                                Info</a>
                        </li>

                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 @if(Request::url() == route('seller_security')) active @endif" href="{{route('seller_security')}}">Security</a>
                        </li>
                    </ul>
                </div>
            </div>
