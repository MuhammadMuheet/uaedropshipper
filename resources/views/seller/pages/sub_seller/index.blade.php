        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Sub Seller</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">Sub Seller</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <form  method="post" id="InsertForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <select class=" form-select form-select-solid required-input" name="role" onchange="toggleOptionsField(this, '1')" required>
                        ...
                        <form  method="post" id="editForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control form-control-solid" placeholder="Enter Password" name="edit_password">
                                </div>
