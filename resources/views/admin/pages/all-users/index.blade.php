        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Sub Admins</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">Sub Admins</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <div id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                        <div class="mb-13 text-center">
                            <h1 class="mb-3">Add Sub Admin</h1>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <div id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                        <div class="mb-13 text-center">
                            <h1 class="mb-3">Update Sub Admin</h1>
                        </div>
                        <form  method="post" id="editForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    <label class="d-flex align-items-center fs-6 fw-bold mb-2">Show Password </label>
            ...
            $.ajax({
                ...
                success: function(dataResult) {
                    ...
                    if (dataResult == 1) {
                        ...
                        toastr.success('Sub Admin Block Successfully.');
            ...
            $.ajax({
                ...
                success: function (dataResult) {
                    ...
                    if (dataResult == 1) {
                        ...
                        toastr.error('Sub Admin Not Found!');
                    }else {
                        toastr.error('Something Went Wrong.');
                    }
                }
            ...
            $.ajax({
                ...
                success: function (dataResult) {
                    ...
                    if (dataResult == 1) {
                        ...
                        toastr.success('Sub Admin Add Successfully.');
