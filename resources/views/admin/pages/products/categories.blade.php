                        ...
                        <form  method="post" id="InsertForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class=" col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control form-control-solid" placeholder="Enter Category" name="category">
                                </div>
                            </div>
                        ...
                        <form  method="post" id="editForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control form-control-solid" placeholder="Enter Category" name="edit_category" id="edit_category">
                                </div>
                            </div>
                            <div class="text-center">
                                <button type="button" class="btn btn-light me-3" data-bs-dismiss="modal">Cancel</button>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(dataResult) {
                    ...
                    if (dataResult == 1) {
                        ...
                        toastr.success('Category Block Successfully.');
                        setTimeout(function () {
        ...
        $('body').on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (dataResult) {
                    console.log(dataResult);
                    $('#edit_category').val(dataResult.category);
            ...
            $.ajax({
                ...
                type: 'GET', data: {
                    ...
                    if (data == 1) {
                        ...
                        toastr.error('Category has subcategories, cannot delete');
