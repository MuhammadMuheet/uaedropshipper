                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <div id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                        <div class="mb-13 text-center">
                            <h1 class="mb-3">Add Sub Category</h1>
                        </div>
                        <form  method="post" id="InsertForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class=" col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <select class="js-example-basic-single form-select form-select-solid"  name="category_id">
                            ...
                            <div class="row">
                                <div class=" col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control form-control-solid" placeholder="Enter Sub Category" name="sub_category">
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <div id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                        <div class="mb-13 text-center">
                            <h1 class="mb-3">Update Sub Category</h1>
                        </div>
                        <form  method="post" id="editForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class=" col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <select class="js-example-basic-single1 form-select form-select-solid"  name="edit_category_id" id="edit_category_id">
                                        <option value="" selected disabled>Choose Category</option>
                                        @foreach($Categories as $Category)
                                            <option value="{{$Category->id}}">{{$Category->category}}</option>
                                        @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control form-control-solid" placeholder="Enter Sub Category" name="edit_sub_category" id="edit_sub_category">
                                </div>
                            </div>
...
@push('js')
    ...
    <script>
        function changeStatus(newStatus, id) {
            ...
            $.ajax({
                url: "{{ route('status_sub_categories') }}",
                type: "GET",
                data: {
                    status: newStatus,
                    id: id,
                ...
                success: function(dataResult) {
                    ...
                    if (dataResult == 1) {
                        ...
                        toastr.success('Sub Category Block Successfully.');
                        setTimeout(function () {
                            window.location.reload();
                        }, 1000);
                    } else if (dataResult == 2) {
                        $('#table').DataTable().ajax.reload(null, false);
                        toastr.success('Sub Category Active Successfully.');
                    }else {
        ...
        $('body').on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (dataResult) {
                    ...
                    $('#edit_sub_category').val(dataResult.sub_category);
                    $('#edit_category_id').val(dataResult.category_id).change();
                }
            });
        });
        ...
        function update_item() {
            ...
            $.ajax({
                url: "{{route('update_sub_categories')}}",
                type: "POST",
                data: form_Data,
                contentType: false,
                cache: false,
                ...
                success: function (dataResult) {
                    ...
                    if (dataResult == 1) {
                        ...
                        toastr.error('Enter a Sub Category');
        ...
        function deleteItem(deleteid) {
            ...
            $.ajax({
                url: '{{route('delete_sub_categories')}}',
                type: 'GET', data: {
                    id: deleteid,
            ...
            $.ajax({
                ...
                success: function (dataResult) {
                    ...
                    if (dataResult == 1) {
                        ...
                        toastr.success('Sub Category Add Successfully.');
                        ...
                        toastr.error('Selected category does not exist');
                    }
                    else {
                        toastr.error('Something Went Wrong.');
                    }
