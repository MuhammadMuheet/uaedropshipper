                                ...
                                <div class="widget-content widget-content-area card">
                                    <div class="card-header border-0 pt-6 w-100">
                                        <div class="col-md-12 mt-3" id="filter_section" style="display: none;">
                                            <div class="row">
                                                <div class="col-md-3 mt-3">
                                                    ...
                                                    <select name="seller" id="seller" class="js-example-basic-single2 form-control form-control-solid">
                                                ...
                                                <div class="col-md-3 mt-3">
                                                    ...
                                                    <select name="logistic_company" id="logistic_company" class="js-example-basic-single2 form-control form-control-solid" onchange="get_drivers(this.value)">
                                                ...
                                                <div class="col-md-3 mt-3"  >
                                                    ...
                                                    <select name="drivers" id="drivers" class="js-example-basic-single1 form-control form-control-solid">
                                        ...
                                        <div class="col-md-6 mt-3 text-md-end text-center">
                                            ...
                                            <button type="button" class="btn btn-light-info me-3" id="bulkPrintBtn" style="display: none;">
                        ...
                        <form  method="post" id="InsertForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class=" col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    <label class="required mb-2">Logistic Company</label>
                                    <select name="assign_logistic_company" id="assign_logistic_company" class="js-example-basic-single2 form-control form-control-solid">
                                        <option value="" selected>Choose a Logistic Company</option>
                                        @foreach($LogisticCompanyData as $LogisticCompany)
                                            <option value="{{$LogisticCompany->id}}">{{$LogisticCompany->name}}</option>
                                        @endforeach
...
function toggleBulkAssignButton() {
    if ($('#main_action:checked').length > 0) {
        ...
        $(document).ready(function() {
            ...
            $('#logistic_company,#drivers,#seller,#status,#state,#area,#current_date,#start_date,#end_date').on('change', function () {
                table.ajax.reload();
            });
        });
        function reset_table() {
            $('#logistic_company,#drivers,#status,#seller,#state,#area,#current_date,#start_date,#end_date,#search').val('').trigger('change');
