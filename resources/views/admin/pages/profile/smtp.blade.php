        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">SMTP</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <div class="card-body pt-9 pb-0">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                            ...
                            @endif
                                ...
                                <li class="nav-item mt-2">
                                    <a class="nav-link text-active-primary ms-0 me-10 py-5 @if(Request::url() == route('smtp')) active @endif" href="{{route('smtp')}}">SMTP</a>
                                </li>
                            @endif
                        </ul>
                    </div>
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_signin_method">
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">SMTP</h3>
                        </div>
                    </div>
                    <!--end::Card header-->
                    <!--begin::Content-->
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="d-flex flex-wrap align-items-center ">
                                ...
                                <div id="kt_signin_password_edit" class="flex-row-fluid ">
                                    <!--begin::Form-->
                                    <form id="kt_signin_change_smtp" method="post" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                                        @csrf
                                        <div class="row mb-4">
                                            <div class="col-lg-6">
                                                <div class="fv-row mb-0 fv-plugins-icon-container">
                                                    <label for="mail_host" class="form-label fs-6 fw-bolder mb-3">Mail Host</label>
                                                    <input type="text" class="form-control form-control-lg form-control-solid" placeholder="Mail Host" name="mail_host" id="mail_host">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="fv-row mb-0 fv-plugins-icon-container">
                                                    <label for="mail_enc" class="form-label fs-6 fw-bolder mb-3">Mail Enc</label>
                                                    <input type="text" class="form-control form-control-lg form-control-solid" name="mail_enc" id="mail_enc" placeholder="Mail Enc">
                                                  </div>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-lg-6">
                                                <div class="fv-row mb-0 fv-plugins-icon-container">
                                                    <label for="mail_username" class="form-label fs-6 fw-bolder mb-3">Mail Username</label>
                                                    <input type="text" class="form-control form-control-lg form-control-solid" name="mail_username" id="mail_username" placeholder="Mail Username">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="fv-row mb-0 fv-plugins-icon-container">
                                                    <label for="mail_password" class="form-label fs-6 fw-bolder mb-3">Mail Password</label>
                                                    <input type="text" class="form-control form-control-lg form-control-solid" name="mail_password" id="mail_password" placeholder="Mail Password">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-lg-6">
                                                <div class="fv-row mb-0 fv-plugins-icon-container">
                                                    <label for="mail_port" class="form-label fs-6 fw-bolder mb-3">Mail Port</label>
                                                    <input type="text" class="form-control form-control-lg form-control-solid" name="mail_port" id="mail_port" placeholder="Mail Port">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="fv-row mb-0 fv-plugins-icon-container">
                                                    <label for="admin_email" class="form-label fs-6 fw-bolder mb-3">Admin Email</label>
                                                    <input type="text" class="form-control form-control-lg form-control-solid" name="admin_email" id="admin_email" placeholder="Admin Email">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex">
                                            <button id="kt_password_submit" onclick="update_tool()" type="button" class="btn btn-primary me-2 px-6">Save</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
@push('js')
    <script>
        function update_tool() {
            var form_Data = new FormData(document.getElementById("kt_signin_change_smtp"));
            document.getElementById("kt_password_submit").innerHTML = "Loading....";
            document.getElementById('kt_password_submit').disabled = true;
            $.ajax({
                url: "{{route('smtp_update')}}",
                type: "POST",
                data: form_Data,
                contentType: false,
                cache: false,
                ...
                success: function (dataResult) {
                    ...
                    document.getElementById("kt_password_submit").innerHTML = "Save";
                    document.getElementById('kt_password_submit').disabled = false;
                    if (dataResult == 1) {
                        document.getElementById("kt_signin_change_smtp").reset();
                        fetch_profile()
        ...
        function fetch_profile() {
            $.ajax({
                ...
                success: function (dataResult) {
                    console.log(dataResult);
                    $('#mail_host').val(dataResult.MAIL_HOST);
                    $('#mail_enc').val(dataResult.MAIL_ENCRYPTION);
                    $('#mail_username').val(dataResult.MAIL_USERNAME);
                    $('#mail_password').val(dataResult.MAIL_PASSWORD);
                    $('#mail_port').val(dataResult.MAIL_PORT);
                    $('#admin_email').val(dataResult.MAIL_FROM_ADDRESS);
                }
            });
        }
    </script>
