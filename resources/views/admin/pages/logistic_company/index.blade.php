...
@section('title','Logistic Companies')
@section('content')
    @php
        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Logistic Companies</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">Logistic Companies</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <div id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                        <div class="mb-13 text-center">
                            <h1 class="mb-3">Add Logistic Company</h1>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <div id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                        <div class="mb-13 text-center">
                            <h1 class="mb-3">Update Logistic Company</h1>
                        </div>
...
@push('js')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            var table = $('#table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('all_logistic_companies') }}",
                    type: 'GET'
                },
                columns: [
                    {data: 'id', name: 'id'},
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(dataResult) {
                    ...
                    if (dataResult == 1) {
                        ...
                        toastr.success('Logistic Company Block Successfully.');

                    } else if (dataResult == 2) {
                        $('#table').DataTable().ajax.reload(null, false);
                        toastr.success('Logistic Company Active Successfully.');
                    }
                    else {
        ...
        function update_item() {
            ...
            $.ajax({
                url: "{{route('update_logistic_companies')}}",
                type: "POST",
                data: form_Data,
                contentType: false,
                cache: false,
                ...
                success: function (dataResult) {
                    ...
                    if (dataResult == 1) {
                        ...
                        toastr.error('Enter a Logistic Company');
                    }else if(dataResult == 3){
                        toastr.error('Logistic Company Not Found!');
                    }else {
                        toastr.error('Something Went Wrong.');
                    }
                }
        ...
        function deleteItem(deleteid) {
            ...
            $.ajax({
                url: '{{route('delete_logistic_companies')}}',
                type: 'GET', data: {
                    id: deleteid,
        ...
        function insert_item() {
            ...
            $.ajax({
                url: "{{route('add_logistic_companies')}}",
                type: "POST",
                data: form_Data,
                contentType: false,
                cache: false,
                ...
                success: function (dataResult) {
                    ...
                    if (dataResult == 1) {
                        ...
                        toastr.success('Logistic Company Add Successfully.');
