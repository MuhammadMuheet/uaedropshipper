            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">{{ucfirst($driver_data->name)}}</li>
                    </ul>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="card-header border-0 pt-6 w-100">
                                        <div class="col-md-12 mt-3" id="filter_section" style="display: none;">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mt-3" id="start_date_display" >
                                                ...
                                                <div class="col-md-6 mt-3" id="end_date_display">
  ...
  function toggleFilter() {
        ...
        $(document).ready(function() {
            var table = $('#table').DataTable({
                ...
                order: [[1, 'desc']],
                ajax: {
                    url: "{{ route('all_driver_admin_orders', $id) }}",
                    type: 'GET',
                    data: function (d) {
                        d.state = $('#state').val();
                        d.area = $('#area').val();
            ...
            $('#status,#state,#area,#start_date,#end_date').on('change', function () {
                table.ajax.reload();
            });
        });
        function reset_table() {
            $('#status,#state,#area,#start_date,#end_date,#search').val('').trigger('change');
