                                        ...
                                        <div class="col-md-12 mt-3" id="filter_section" style="display: none;">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 mt-3">
                                                    ...
                                                    <select name="usertype" id="usertype" class=" form-control form-control-solid">
                        ...
                        <form  method="post" id="InsertForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class=" col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <select class="form-select form-select-solid"  name="user_type" id="user_type" onchange="get_area(this.value)">
                                ...
                                <div class=" col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <select name="user_id" id="user_id" class="js-example-basic-single3 form-control form-control-solid">
                                ...
                                <div class=" col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                   ...
                                   <input type="text" class="form-control form-control-solid" name="amount" id="amount" placeholder="Enter Amount" required>
                                </div>
        ...
        $(document).ready(function() {
            var table = $('#table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'AmountType', name: 'AmountType' },
