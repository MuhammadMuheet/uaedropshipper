                                    ...
                                    <div class="card-header border-0 pt-6 w-100">
                                        <div class="col-md-12 mt-3" id="filter_section" style="display: none;">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mt-3">
                                                    <label class="required mb-2">Sub Seller</label>
                                                    <select name="sub_seller" id="sub_seller" class="js-example-basic-single2 form-control form-control-solid">
                                                        <option value="" selected>Choose a Sub Seller</option>
                                                        @foreach($SubsellerData as $Subseller)
                                                            <option value="{{$Subseller->id}}">{{$Subseller->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mt-3">
    ...
    function toggleFilter() {
        ...
        $(document).ready(function() {
            var table = $('#table').DataTable({
                ...
                order: [[0, 'desc']],
                ajax: {
                    url: "{{ route('all_seller_orders_admin', $id) }}",
                    type: 'GET',
                    data: function (d) {
                        d.state = $('#state').val();
                        d.area = $('#area').val();
