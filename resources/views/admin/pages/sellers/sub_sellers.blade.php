        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Sub Sellers</h1>
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <div id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                        <div class="mb-13 text-center">
                            <h1 class="mb-3">Add Sub Seller</h1>
                        </div>
                        <form  method="post" id="InsertForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <select class=" form-select form-select-solid required-input" name="role" required>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <div id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                        <div class="mb-13 text-center">
                            <h1 class="mb-3">Update Sub Seller</h1>
                        </div>
                        <form  method="post" id="editForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    <label class="form-label">Role</label>
                                    <select class=" form-select form-select-solid required-input" name="edit_role" required>
                                        <option value="">Choose Role</option>
                                        @foreach($roles as $role)
                                            <option value="{{$role->id}}">{{$role->name}}</option>
                                        @endforeach
...
@push('js')
    ...
    <script>
        ...
        function insert_item() {
            ...
            $.ajax({
                url: "{{route('add_admin_sub_sellers')}}",
                type: "POST",
                data: form_Data,
                contentType: false,
                cache: false,
