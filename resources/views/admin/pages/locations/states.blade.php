        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">States</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">States</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <form  method="post" id="InsertForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class=" col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control form-control-solid" placeholder="Enter State" name="state">
                                </div>
                            </div>
                        ...
                        <form  method="post" id="editForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control form-control-solid" placeholder="Enter State" name="edit_state" id="edit_state">
                                </div>
                            </div>
                            <div class="text-center">
                                <button type="button" class="btn btn-light me-3" data-bs-dismiss="modal">Cancel</button>
        ...
        $('body').on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (dataResult) {
                    ...
                    $('#edit_state').val(dataResult.state);
            ...
            $.ajax({
                ...
                type: 'GET', data: {
                    ...
                    if (data == 1) {
                        ...
                        toastr.error('State has Areas, cannot delete');
                    } else {
                        toastr.error('Something went wrong.');
            ...
            $.ajax({
                ...
                success: function (dataResult) {
                    ...
                    if (dataResult == 1) {
                        ...
                        toastr.success('State Add Successfully.');
