...
<div class="dashboard-container">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-6 col-md-6">
            <div class="management-card">
                <h5 class="mb-3" style="color: var(--text-primary); font-weight: 600;">
                    <i class="fas fa-box text-primary-custom me-2"></i>
                    Inventory Stocks
                </h5>
                <div class="management-item bg-primary-light mb-3">
                ...
                <div class="management-item bg-danger-light mb-3">
                    ...
                    @if($lowStock > 0)
                        <button type="button" class="btn btn-sm btn-outline-danger ms-2" data-bs-toggle="modal" data-bs-target="#lowStockModal" style="  margin-right: 6px;
    background: #000000;
    ...
    color: #ffffff;">
                ...
                <div class="management-item bg-info-light">
                    ...
                    @if($outOfStock > 0)
                        <button type="button" class="btn btn-sm btn-outline-info ms-2" data-bs-toggle="modal" data-bs-target="#outOfStockModal" style="  margin-right: 6px;
                        background: #ff0000;
                        padding: 0px 10px 0px;
                        color: #ffffff;">
                            View
                            ...
                            <tbody>
                                @foreach($lowStockProducts as $product)
                                    <tr>
                                        ...
                                        <td>{{ $product->variation_name ? $product->variation_name . ': ' . $product->variation_value : 'N/A' }}</td>
