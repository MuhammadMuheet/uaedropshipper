@extends('logistic_company.layouts.app')
                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 @if(Request::url() == route('logistic_company_profile')) active @endif" href="{{route('logistic_company_profile')}}">Basic
                                Info</a>
                        </li>

                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 @if(Request::url() == route('logistic_company_security')) active @endif" href="{{route('logistic_company_security')}}">Security</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <form id="kt_account_profile_details_form" method="post" enctype="multipart/form-data" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <!--begin::Image input-->
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{asset('assets/media/svg/avatars/blank.svg')}});background-position: center; background-size: contain;">
                                        <!--begin::Preview existing avatar-->
                                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ asset('storage/users/' . Auth::user()->image) }}');background-position: center; background-size: contain;"></div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                            <input type="text" name="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Full Name" >
                                            <div class="fv-plugins-message-container invalid-feedback"></div></div>
                            </div>
                            <div class="row mb-6">
                                <label class="col-lg-4 col-form-label required fw-bold fs-6">Email</label>
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <input type="email" name="email" class="form-control form-control-lg form-control-solid" placeholder="exmaple@gmail.com" readonly>
                                    <div class="fv-plugins-message-container invalid-feedback"></div></div>
                            </div>
                            <div class="row mb-6">
                                <label class="col-lg-4 col-form-label required fw-bold fs-6">Phone No</label>
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <input type="tel" name="mobile" class="form-control form-control-lg form-control-solid" placeholder="+xxxxxxxxxxxx" >
                                    <div class="fv-plugins-message-container invalid-feedback"></div></div>
                            </div>
                        </div>
...
@push('js')
    <script>
        ...
        function get_profile() {
            var id = {{ Auth::user()->id }};
            $.ajax({
                url: "{{Route('logistic_company_get_profile')}}",
                type: "get",
                data: {
                    id: id,
                },
        ...
        function update_tool() {
            ...
            $.ajax({
                url: "{{route('logistic_company_profile_update')}}",
                type: "POST",
                data: form_Data,
                contentType: false,
                cache: false,
