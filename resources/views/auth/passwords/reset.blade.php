...
background-size: cover; ">
            ...
            <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y" style="background-color: rgba(1,1,1,0.7);">
                ...
                <div class="d-flex flex-column text-center mt-20 p-10 pt-lg-20">
                    ...
                    <!--end::Logo-->
                    <!--begin::Title-->
                    <h1 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color: #fff;">Reset Password</h1>
                    <!--end::Title-->
                    <!--begin::Description-->
                ...
                <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="text-center mb-10">
                            ...
                            <p>Enter your password for login.Your new password must be different from previously used passwords</p>
                        </div>
                        @if(session('status'))
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <input class="form-control form-control-lg form-control-solid" type="text" id="email" name="email"   value="{{ $email ?? old('email') }}"  placeholder="Enter your email"/>

                        </div>
                        <div class="fv-row mb-10">
                                <label class="form-label fw-bolder text-dark fs-6 mb-0">New Password</label>
                            <input class="form-control form-control-lg form-control-solid" type="password" name="password" required id="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" />
                        </div>
                        <div class="fv-row mb-10">
                                <label class="form-label fw-bolder text-dark fs-6 mb-0">Confirm Password</label>
                            <input class="form-control form-control-lg form-control-solid" type="password" name="password_confirmation"  required id="password-confirm" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" />
                        </div>
