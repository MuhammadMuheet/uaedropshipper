                ...
                <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y" style="background: linear-gradient(to bottom, #2563eb, #000000); ">
                    ...
                    <div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain justify-content-center bgi-position-y-bottom min-h-100px min-h-lg-350px" >
                        <div class="d-flex align-items-center">
                            <a href="https://pk.linkedin.com/company/pitgpk" class="symbol symbol-circle symbol-45px w-45px bg-light me-3">
                            ...
                            <a href="https://web.facebook.com/pitg.pk/" class="symbol symbol-circle symbol-45px w-45px bg-light me-3">
    ...
    function insert_item() {
        ...
        $.ajax({
            ...
            success: function (dataResult) {
                ...
                } else if(dataResult == 7){
                    notie.alert({type: 'error', text: 'This email is already in use', time: 4});
                }else {
